...
def pick_number_sets(numbers_list, set_size=6, num_sets=10):
    """
...
my_numbers = [36, 2, 8, 28, 32, 5, 25, 29, 22, 23, 41, 9, 27, 17, 3, 12, 6, 7, 34, 13, 20, 33, 38, 37 ]

# Call the function to get 10 sets of 6 numbers.
selected_sets = pick_number_sets(my_numbers, set_size=6, num_sets=10)

# Print the results in a readable format.
if selected_sets:
    print(f"Here are {len(selected_sets)} random sets of 6 numbers:")
